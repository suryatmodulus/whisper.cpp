...
struct whisper_params {
    ...
    std::string model_wsp = "models-whisper/ggml-base.en.bin";
    std::string model_gpt = "models-gpt/gpt-2-117M.bin";
    std::string speak     = "speak.sh";
...
Santa: I'm sorry, but only good boys and girls get to ride in my sleigh. But don't worry, if you keep being good, you might get to ride with me one day.
)" },
    { "Kid",
R"(Kid: Hi Santa! Are you real?
Santa: Of course I am, my dear! Ho ho ho!
